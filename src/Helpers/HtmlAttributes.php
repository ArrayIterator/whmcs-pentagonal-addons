...
class HtmlAttributes
{
     ...
     * @return string
     */
    public static function buildTag(string $tag, array $attributes, ?string $content = '') : string
    {
        $tag = strtolower(trim($tag));
        $is_single = in_array($tag, self::SINGLE_TAG);
        $attribute = self::buildAttributes($attributes);
        return $is_single ? "<$tag $attribute>" : "<$tag $attribute>$content</$tag>";
    }
