...
class ResponseEmitter implements ResponseEmitterInterface
{
    ...
    public const MAX_BUFFER = 32768;
    public const MIN_BUFFER = 1024;
    public const DEFAULT_BUFFER = 8192;

    /**
     * Maximum output buffering size for each iteration.
     */
    protected int $maxBufferLength = self::DEFAULT_BUFFER;
    ...
    public function __construct(int $maxBufferLength = self::DEFAULT_BUFFER)
    {
        $this->maxBufferLength = min(max($maxBufferLength, self::MIN_BUFFER), self::MAX_BUFFER);
    }
     ...
     *
     * @param StreamInterface|ResponseInterface $responseOrStream
